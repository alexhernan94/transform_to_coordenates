...
df = pd.read_csv('D:/Proyectos/ProyectosPython/transform_to_coordenates/coordenadas.csv', sep=',')
...
df_final.to_csv("D:/Proyectos/ProyectosPython/transform_to_coordenates/coverted_coordenates.csv")
